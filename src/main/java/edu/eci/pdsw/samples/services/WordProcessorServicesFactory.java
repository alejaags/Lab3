...
import edu.eci.pdsw.samples.persistence.impl.EncodingValidator;
...
public class WordProcessorServicesFactory {
    ...
    public EncodingValidator getValidator(){
        return injector.getInstance(EncodingValidator.class);
    }
